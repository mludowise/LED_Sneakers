...
class ColorButton : public Button {
  private:
    ...
    const int mEepromAddress;       // The address of where the currently color index is stored in EEPROM memory
  ...
  public:
    ...
    // The address of where the currently color index is stored in EEPROM memory
    ColorButton(int pin, int input, int threshold, int numColors, float colorOffset, ShoeAnimation* animationPtr, int eepromAddress);
